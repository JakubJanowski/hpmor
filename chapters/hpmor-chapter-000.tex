...
All science mentioned is real science. But please keep in mind that, beyond the realm of science, the opinions of characters in this story are not necessarily those of the author. Not everything the protagonist does is a lesson in wisdom, and advice offered by darker characters, while sometimes valuable, may also be dangerously double-edged.

\chapter*{Author's introduction}
% from https://www.hpmor.com/chapter/22

\begin{parsepskip}
\centerline{\textit{Something, somewhere, somewhen, must have happened differently{\ldots}}}
...
\item \textsc{Deputy Headmistress Minerva Mcgonagall} needs to go off somewhere private and scream for a while.
\end{itemize}
\end{parsepskip}
