...
Somehow Harry had been thinking that, surely, all the truth would come out by the end of the school year; like that was the end of a mystery novel and the mystery's answer had been promised him. Certainly it had to be known by the time the Defence Professor{\ldots} died, it couldn't be allowed for Professor Quirrell to \emph{die} without knowing the answer, without everything being neatly resolved. Not exam grades, certainly not death, it was only truth that finished a story{\ldots}
...
``Snape{\ldots} listen{\ldots}" said the Defence Professor between coughs. ``Why{\ldots} Sprout{\ldots} here{\ldots}"
...
``Harry{\ldots}" the Defence Professor said in a faltering voice. ``Harry, I'm dying{\ldots}"
