...
But it was also clear that the Headmaster wouldn't be satisfied until Harry went all cold and darkish, and came up with some sort of answer that sounded impressively cunning{\ldots} which had better not \emph{actually} get in the way of Professor Quirrell's teaching Defence{\ldots}
