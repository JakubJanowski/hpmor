...
\emph{That if you \emph{really} believed in an afterlife, you'd go down to St.\?Mungo's and kill Neville's parents, Alice and Frank Longbottom, so they could go on to their \emph{next great adventure}, instead of letting them linger here in their damaged state\---}
